...
function yupik_post_boot() {
    ddr_type=`od -An -tx /proc/device-tree/memory/ddr_device_type`
    ddr_type4="07"
    ddr_type5="08"

    # Disable Core control on silver/gold/goldplus
    ...
    echo "yupik init post done" > /dev/kmsg
}

function katmai_post_boot() {
    ...
    echo "katmai init post done" > /dev/kmsg
}
